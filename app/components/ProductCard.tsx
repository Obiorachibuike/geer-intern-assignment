...
import { Product } from '../types/Product'; // adjust the path to your types if needed
...
const ProductCard = ({ product }: ProductCardProps) => {
  ...
  return (
    <div
      ref={cardRef}
      className={`bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 ease-out overflow-hidden transform ${
    ...
    >
      ...
      <div className="p-6 flex flex-col justify-between h-[calc(100%-12rem)]">
        ...
        <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-100">
          ...
          <button className="bg-gradient-to-r from-purple-500 to-indigo-600 text-white font-bold py-2.5 px-6 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
            Add to Cart
          </button>
        </div>
      </div>
